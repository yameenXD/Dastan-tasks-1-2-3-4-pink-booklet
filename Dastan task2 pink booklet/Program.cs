...
class Dastan
{
    ...
    private MoveOption CreateMoveOption(string Name, int Direction)
    {
        ...
        else if (Name == "faris") // if name is equal to faris it calls the CreateFarisMoveOption function 
        {
            return CreateFarisMoveOption(Direction);// is returns the CreateFarisMoveOption
        }
        else
        {
