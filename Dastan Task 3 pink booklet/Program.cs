...
class Dastan
{
    ...
    private void CreateMoveOptionOffer()
    {
        ...
        MoveOptionOffer.Add("sarukh"); // this will add this particular move to the move option queue
    ...
    {
        //possible moves for Sarukh
        MoveOption NewMoveOption = new MoveOption("sarukh");
        Move NewMove = new Move(0, 2 * Direction);
        NewMoveOption.AddToPossibleMoves(NewMove);
        
        NewMove = new Move(1 * Direction, 0);
        NewMoveOption.AddToPossibleMoves(NewMove);

        NewMove = new(1 * Direction, 1 * Direction);
        NewMoveOption.AddToPossibleMoves(NewMove);
    ...
    private MoveOption CreateMoveOption(string Name, int Direction)
    {
        ...
        {
            // this will call the CreateSarukhMoveOption 
